...
SCENARIO("A Kilogram can be converted into various units.") {
  GIVEN("1 kg") {
    ...
    WHEN("cast into grams") {
      auto grams = mass_cast<si::grams>(kg);
      THEN("the count is 1000") { REQUIRE(grams.count() == 1000); }
    }

    WHEN("cast into pounds") {
      auto pounds = mass_cast<imperial::pounds>(kg);
...
SCENARIO("imperial units can convert correctly.") {
  GIVEN("1 grains") {
    ...
    WHEN("converted to pounds") {
      auto pounds = mass_cast<imperial::pounds>(gr);
    ...
    WHEN("converted to milligrams") {
      auto mg = mass_cast<si::milligrams>(gr);
  ...
  GIVEN("1 drachm") {
    ...
    WHEN("converted to pounds") {
      auto pounds = mass_cast<imperial::pounds>(dr);
  ...
  GIVEN("1 ounce") {
    ...
    WHEN("converted to pounds") {
      auto pounds = mass_cast<imperial::pounds>(oz);
  ...
  GIVEN("1 pound") {
    ...
    WHEN("converted to kilograms") {
      auto kg = mass_cast<si::kilograms>(lbs);
  ...
  GIVEN("1 stone") {
    ...
    WHEN("converted to pounds") {
      auto pounds = mass_cast<imperial::pounds>(st);
      THEN("count is 14 pounds") { REQUIRE(pounds.count() == Approx(14)); }
    }

    WHEN("converted to kilograms") {
      auto kg = mass_cast<si::kilograms>(st);
  ...
  GIVEN("1 quarter") {
    ...
    WHEN("converted to pounds") {
      auto pounds = mass_cast<imperial::pounds>(qr);
      THEN("count is 28 pounds") { REQUIRE(pounds.count() == Approx(28)); }
    }

    WHEN("converted to kilograms") {
      auto kg = mass_cast<si::kilograms>(qr);
  ...
  GIVEN("1 hundredweight") {
    ...
    WHEN("converted to pounds") {
      auto pounds = mass_cast<imperial::pounds>(cwt);
      THEN("count is 112 pounds") { REQUIRE(pounds.count() == Approx(112)); }
    }

    WHEN("converted to kilograms") {
      auto kg = mass_cast<si::kilograms>(cwt);
  ...
  GIVEN("1 ton") {
    ...
    WHEN("converted to pounds") {
      auto pounds = mass_cast<imperial::pounds>(t);
      THEN("count is 2240 pounds") { REQUIRE(pounds.count() == Approx(2240)); }
    }

    WHEN("converted to kilograms") {
      auto kg = mass_cast<si::kilograms>(t);
  ...
  GIVEN("1 slug") {
    ...
    WHEN("converted to pounds") {
      auto pounds = mass_cast<imperial::pounds>(slug);
    ...
    WHEN("converted to kilograms") {
      auto kg = mass_cast<si::kilograms>(slug);
